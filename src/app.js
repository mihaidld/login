...
/*Si l'on crée dans notre projet express un dossier public qui contient tous les
fichiers génerés par un build react, (yarn build générera votre app react, tous
les fichiers et dossiers génerés seront stockés sous le repertoire build/) on
pourra ainsi servir ce dossier */
//serve static files -> Accès à une app react en allant sur http://IP:PORT
